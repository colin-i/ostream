...
Unacceptable TLS certificate? Overwrite libgiognutls.so from glib-networking.i686 deployment with [bionic release equivalent](https://github.com/colin-i/test/releases/download/1.1/libgiognutls.so). \
\
